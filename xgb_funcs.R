#' NOTE: Taken from xgboost Git repo, as it doesn't come with standard CRAN xgboost package (https://github.com/dmlc/xgboost/blob/master/R-package/R/xgb.plot.multi.trees.R)
